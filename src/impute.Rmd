...
The out-of-bag (OOB) error is `r round(anes_imputed$OOBerror[2], 5)`, which can be considered equivalent to ~ 92% accuracy since the variables being imputed on are binary.
